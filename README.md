...
[![PyPI](https://img.shields.io/pypi/v/cognis-leadforge.svg)](https://pypi.org/project/cognis-leadforge/)
[![CI](https://github.com/cognis-digital/leadforge/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/leadforge/actions)
...
LEADFORGE exists for one job — lightweight mcp-native crm pipeline with email sequences — and does it without a SaaS bill or heavyweight setup.
...
```bash
leadforge --version
leadforge scan .                      # scan the current project
leadforge scan . --format json
leadforge scan . --fail-on high       # non-zero exit for CI gates
leadforge mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **Twenty / EspoCRM**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`leadforge` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).
