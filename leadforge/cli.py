...
import argparse, sys
from leadforge.core import scan, to_json, TOOL_NAME, TOOL_VERSION

def main(argv=None) -> int:
    ap = argparse.ArgumentParser(prog="leadforge", description="LEADFORGE — Cognis Neural Suite")
    ...
    if args.cmd == "mcp":
        from leadforge.mcp_server import serve
        return serve()
    if args.cmd == "scan":
