"""Native cognis-connect emit for leadforge — forward findings to any platform.

Maps leadforge's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    leadforge ... --format json | leadforge-emit --to stix
    leadforge-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
