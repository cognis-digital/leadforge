"""LEADFORGE core — Lightweight MCP-native CRM pipeline with email sequences."""
...
RULES = [
    ("LEA-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("LEA-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("LEA-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
